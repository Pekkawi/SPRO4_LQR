...
#include "m_ggLP3aJyTItGILkt3OWKwB.h"
...
static void cgxe_mdl_start(InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  beagleboneblue_bbblueServo *obj);
static void mw__internal__call__reset(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_ggLP3aJyTItGILkt3OWKwB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_ggLP3aJyTItGILkt3OWKwB(SimStruct *S, int_T tid)
{
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_ggLP3aJyTItGILkt3OWKwB(SimStruct *S)
{
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_ggLP3aJyTItGILkt3OWKwB(SimStruct *S, int_T tid)
{
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_ggLP3aJyTItGILkt3OWKwB(SimStruct *S)
{
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_ggLP3aJyTItGILkt3OWKwB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_ggLP3aJyTItGILkt3OWKwB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_ggLP3aJyTItGILkt3OWKwB(SimStruct *S)
{
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_ggLP3aJyTItGILkt3OWKwB(SimStruct *S)
{
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_ggLP3aJyTItGILkt3OWKwB(SimStruct *S)
{
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_ggLP3aJyTItGILkt3OWKwB(SimStruct *S)
{
  InstanceStruct_ggLP3aJyTItGILkt3OWKwB *moduleInstance =
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB *)calloc(1, sizeof
    (InstanceStruct_ggLP3aJyTItGILkt3OWKwB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_ggLP3aJyTItGILkt3OWKwB);
  ssSetmdlInitializeConditions(S, mdlInitialize_ggLP3aJyTItGILkt3OWKwB);
  ssSetmdlUpdate(S, mdlUpdate_ggLP3aJyTItGILkt3OWKwB);
  ssSetmdlDerivatives(S, mdlDerivatives_ggLP3aJyTItGILkt3OWKwB);
  ssSetmdlTerminate(S, mdlTerminate_ggLP3aJyTItGILkt3OWKwB);
  ssSetmdlEnable(S, mdlEnable_ggLP3aJyTItGILkt3OWKwB);
  ssSetmdlDisable(S, mdlDisable_ggLP3aJyTItGILkt3OWKwB);
...
static void mdlProcessParameters_ggLP3aJyTItGILkt3OWKwB(SimStruct *S)
{
}

void method_dispatcher_ggLP3aJyTItGILkt3OWKwB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_ggLP3aJyTItGILkt3OWKwB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_ggLP3aJyTItGILkt3OWKwB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_ggLP3aJyTItGILkt3OWKwB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_ggLP3aJyTItGILkt3OWKwB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: ggLP3aJyTItGILkt3OWKwB.\n"
...
mxArray *cgxe_ggLP3aJyTItGILkt3OWKwB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_ggLP3aJyTItGILkt3OWKwB_fallback_info(void)
{
