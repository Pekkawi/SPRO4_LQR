...
#include "m_rVsXzspjdTrkBZjQOmw8IG.h"
...
static void cgxe_mdl_start(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  beagleboneblue_bbblueServo *obj);
static void mw__internal__call__reset(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_rVsXzspjdTrkBZjQOmw8IG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S, int_T tid)
{
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S)
{
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S, int_T tid)
{
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S)
{
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S)
{
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S)
{
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S)
{
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S)
{
  InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *moduleInstance =
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG *)calloc(1, sizeof
    (InstanceStruct_rVsXzspjdTrkBZjQOmw8IG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_rVsXzspjdTrkBZjQOmw8IG);
  ssSetmdlInitializeConditions(S, mdlInitialize_rVsXzspjdTrkBZjQOmw8IG);
  ssSetmdlUpdate(S, mdlUpdate_rVsXzspjdTrkBZjQOmw8IG);
  ssSetmdlDerivatives(S, mdlDerivatives_rVsXzspjdTrkBZjQOmw8IG);
  ssSetmdlTerminate(S, mdlTerminate_rVsXzspjdTrkBZjQOmw8IG);
  ssSetmdlEnable(S, mdlEnable_rVsXzspjdTrkBZjQOmw8IG);
  ssSetmdlDisable(S, mdlDisable_rVsXzspjdTrkBZjQOmw8IG);
...
static void mdlProcessParameters_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S)
{
}

void method_dispatcher_rVsXzspjdTrkBZjQOmw8IG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_rVsXzspjdTrkBZjQOmw8IG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_rVsXzspjdTrkBZjQOmw8IG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_rVsXzspjdTrkBZjQOmw8IG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_rVsXzspjdTrkBZjQOmw8IG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: rVsXzspjdTrkBZjQOmw8IG.\n"
...
mxArray *cgxe_rVsXzspjdTrkBZjQOmw8IG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_rVsXzspjdTrkBZjQOmw8IG_fallback_info(void)
{
