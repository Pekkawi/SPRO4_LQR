...
#include "m_k8uGJZNtKPoVaLiks9r0mG.h"
...
static void cgxe_mdl_start(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance);
static void mw__internal__system__init__fcn
  (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance);
static void mw__internal__system__terminate__fcn
  (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_checkTunablePropChange(const emlrtStack *sp,
  beagleboneblue_bbblueServo *obj);
static void mw__internal__call__reset(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
...
static int32_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_k8uGJZNtKPoVaLiks9r0mG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S, int_T tid)
{
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S)
{
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S, int_T tid)
{
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S)
{
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S)
{
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S)
{
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S)
{
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S)
{
  InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *moduleInstance =
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG *)calloc(1, sizeof
    (InstanceStruct_k8uGJZNtKPoVaLiks9r0mG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_k8uGJZNtKPoVaLiks9r0mG);
  ssSetmdlInitializeConditions(S, mdlInitialize_k8uGJZNtKPoVaLiks9r0mG);
  ssSetmdlUpdate(S, mdlUpdate_k8uGJZNtKPoVaLiks9r0mG);
  ssSetmdlDerivatives(S, mdlDerivatives_k8uGJZNtKPoVaLiks9r0mG);
  ssSetmdlTerminate(S, mdlTerminate_k8uGJZNtKPoVaLiks9r0mG);
  ssSetmdlEnable(S, mdlEnable_k8uGJZNtKPoVaLiks9r0mG);
  ssSetmdlDisable(S, mdlDisable_k8uGJZNtKPoVaLiks9r0mG);
...
static void mdlProcessParameters_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S)
{
}

void method_dispatcher_k8uGJZNtKPoVaLiks9r0mG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_k8uGJZNtKPoVaLiks9r0mG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_k8uGJZNtKPoVaLiks9r0mG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_k8uGJZNtKPoVaLiks9r0mG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_k8uGJZNtKPoVaLiks9r0mG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: k8uGJZNtKPoVaLiks9r0mG.\n"
...
mxArray *cgxe_k8uGJZNtKPoVaLiks9r0mG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_k8uGJZNtKPoVaLiks9r0mG_fallback_info(void)
{
