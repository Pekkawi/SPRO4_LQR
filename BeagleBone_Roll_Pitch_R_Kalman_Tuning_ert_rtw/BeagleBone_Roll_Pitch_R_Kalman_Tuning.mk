...
PRODUCT_NAME              = BeagleBone_Roll_Pitch_R_Kalman_Tuning
MAKEFILE                  = BeagleBone_Roll_Pitch_R_Kalman_Tuning.mk
MATLAB_ROOT               = .
MATLAB_BIN                = .
MATLAB_ARCH_BIN           = .
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BeagleBone_Roll_Pitch_R_Kalman_Tuning.elf
...
DEFINES_STANDARD = -DMODEL=BeagleBone_Roll_Pitch_R_Kalman_Tuning -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_I2C.c MW_MPU9250.c BeagleBone_Roll_Pitch_R_Kalman_Tuning.c BeagleBone_Roll_Pitch_R_Kalman_Tuning_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_I2C.c.o MW_MPU9250.c.o BeagleBone_Roll_Pitch_R_Kalman_Tuning.c.o BeagleBone_Roll_Pitch_R_Kalman_Tuning_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
BeagleBone_Roll_Pitch_R_Kalman_Tuning.c.o : BeagleBone_Roll_Pitch_R_Kalman_Tuning.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BeagleBone_Roll_Pitch_R_Kalman_Tuning_data.c.o : BeagleBone_Roll_Pitch_R_Kalman_Tuning_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
