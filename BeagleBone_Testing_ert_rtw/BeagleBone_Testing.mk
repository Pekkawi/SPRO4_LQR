###########################################################################
## Makefile generated for component 'BeagleBone_Testing'. 
## 
## Makefile     : BeagleBone_Testing.mk
## Generated on : Mon May 27 23:43:35 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/BeagleBone_Testing.elf
...
PRODUCT_NAME              = BeagleBone_Testing
MAKEFILE                  = BeagleBone_Testing.mk
MATLAB_ROOT               = .
MATLAB_BIN                = .
MATLAB_ARCH_BIN           = .
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/BeagleBone_Testing.elf
...
DEFINES_STANDARD = -DMODEL=BeagleBone_Testing -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = MW_I2C.c MW_MPU9250.c BeagleBone_Testing.c BeagleBone_Testing_data.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MW_bbblue_init.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = MW_I2C.c.o MW_MPU9250.c.o BeagleBone_Testing.c.o BeagleBone_Testing_data.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MW_bbblue_init.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
...
BeagleBone_Testing.c.o : BeagleBone_Testing.c
	$(CC) $(CFLAGS) -o "$@" "$<"


BeagleBone_Testing_data.c.o : BeagleBone_Testing_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
